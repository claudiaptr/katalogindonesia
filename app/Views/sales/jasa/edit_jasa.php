...
<div class="content-wrapper">
    ...
    <section class="content">
        <form role="form" id="demoform" method="post" enctype="multipart/form-data" action="<?= base_url(); ?>sales/update_jasa/<?= $barang['id']; ?>">
            <div class="row">
                <div class="col-xs-12">
                            ...
                            <div class="add-more-variasi">
                                <?php foreach ($variasi as $vri) : ?>
                                    <div class="form-group col-md-12">
                                        ...
                                        <button type="button" class="btn btn-danger remove-variasi">Remove</button> <!-- Tombol remove -->
                                    </div>
                                <?php endforeach; ?>
                            </div>
...
<script>
    ...
    $(".add-variasi").on("click", function() {
        // Membuat form baru untuk variasi
        var card =
            '<div class="form-group col-md-12">' +
            '<label>Nama Variasi</label>' +
            '<input type="text" class="form-control" name="nama_variasi[]" placeholder="Enter nama variasi">' +
            '<button type="button" class="btn btn-danger remove-variasi">Remove</button>' + // Tombol untuk menghapus variasi
            '</div>';
        $(".add-more-variasi").append(card); // Menambahkan form baru ke dalam container
    });

    $(".add-more-variasi").delegate(".remove-variasi", "click", function() {
        $(this).parent().remove(); // Menghapus variasi yang dipilih
    });
