      ...
      <div class="row px-xl-5">
          <div class="col-lg-7 mb-5">
              <div class="contact-form bg-light p-30">
                  ...
                  <?php endif; ?>
                  <form name="sentMessage" id="contactForm" novalidate="novalidate" method="post" action="<?php echo base_url('contact/send'); ?>">
                      ...
                      <div class="control-group">
                          ...
                          <?php if (isset($validation) && $validation->hasError('email')) : ?>
                              <p class="help-block text-danger"><?php echo $validation->getError('email'); ?></p>
                          <?php endif; ?>
                      </div>
                      <div class="control-group">
                      ...
                      <div class="control-group">
                          ...
                          <?php if (isset($validation) && $validation->hasError('message')) : ?>
                              <p class="help-block text-danger"><?php echo $validation->getError('message'); ?></p>
                          <?php endif; ?>
                      </div>
                      <div>
