                      ...
                      <div class="tab-pane fade" id="tab-pane-3">
                          <div class="row">
                                                  ...
                                                  <div class="media-body">
                                                      ...
                                                      <?php if (!empty($value->foto)): ?>
                                                          <div class="review-photo mb-2">
                                                              <img src="<?= base_url('uploads/foto/' . $value->foto); ?>" alt="Review photo" class="img-fluid" style="max-width: 100px;">
                                                              <p><?= $value->foto; ?></p>
                                                          </div>
                                                      <?php endif; ?>
                              ...
                              <div class="col-md-6">
                                  ...
                                  <form action="<?= base_url('user/review/' . $barang['id']); ?>" method="POST" enctype="multipart/form-data">
